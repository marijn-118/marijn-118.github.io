...
# We do NOT rename the column this time, we want it to stay PULocationID
...
# Merge ONLY the rides that STARTED in those 20 extreme zones
...
print("\n--- THE EXTREMES TEST RESULTS (PICKUPS) ---")
print(extreme_tips)
print("-------------------------------------------")
...
plt.title('The Extremes: Safest vs. Most Dangerous Pickups', fontsize=14, pad=15)
...
plt.tight_layout()
plt.savefig('Extremes_Test_From.png', dpi=300)
plt.show()