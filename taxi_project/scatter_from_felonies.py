...
# Create the scatter plot using the new Total_Felonies metric
sns.regplot(
    data=merged_df, 
    x='Total_Felonies', 
    y='tip_percent', 
...
plt.title('Correlation: TRUE Danger (Felonies) vs. Average Tip % (Pickups)', fontsize=14, pad=15)
plt.xlabel('Total Felonies in Pickup Zone (2023)', fontsize=12)
...
plt.tight_layout()
plt.savefig('Scatter_TRUE_Danger_Tip_Pickups.png', dpi=300)
plt.show()
